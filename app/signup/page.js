    ...
    return (
      <div style={{
        ...
        <div style={{ 
          ...
          <h1 style={{ fontSize: '28px', marginBottom: '8px', color: '#f1f1f1' }}>Check your email</h1>
          <p style={{ color: '#a1a1b9' }}>
            We've sent you a confirmation link to <strong style={{ color: '#f1f1f1' }}>{email}</strong>
          </p>
        </div>
      </div>
    )
      ...
      >
        <div style={{ maxWidth: '480px', margin: '0 auto' }}>
          ...
          <p style={{ 
            ...
            Join Shipfolio and showcase every product you build.
          </p>
      ...
      <div style={{
        ...
        <div style={{ maxWidth: '400px', margin: '0 auto', width: '100%' }}>
          ...
          <p style={{ color: '#a1a1b9', marginBottom: '32px', textAlign: 'left' }}>
            Start building your product portfolio today.
          </p>

          <form onSubmit={handleSignup}>
            <div style={{ marginBottom: '20px' }}>
              <label style={{ display: 'block', marginBottom: '6px', fontWeight: '500', fontSize: '14px', color: '#a1a1b9' }}>Username</label>
              <input
                type="text"
                style={{
                  width: '100%',
