...
export default function EditProductPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      setExistingImage(product.thumbnail_url)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      let thumbnailUrl = existingImage
      if (imageFile) {
    ...
    <Sidebar>
      <div style={{ maxWidth: '720px', margin: '0 auto', paddingBottom: '40px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '32px' }}>
          <Link href="/products" style={{ color: '#a1a1b9', textDecoration: 'none', display: 'flex', alignItems: 'center' }}>
            <Icons.ArrowLeft />
          </Link>
          <div>
            <h1 style={{ fontSize: '28px', fontWeight: '700', color: '#f1f1f1' }}>Edit Product</h1>
            <p style={{ color: '#a1a1b9' }}>Update your product details</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ marginBottom: '20px' }}>
            ...
            <div
              style={{
                ...
                cursor: 'pointer',
                transition: 'all 0.2s',
                background: (imagePreview || existingImage) ? '#14141e' : 'transparent'
              }}
            ...
            >
              ...
              {imagePreview ? (
                ...
                <img src={existingImage} alt="Current" style={{ maxHeight: '200px', borderRadius: '8px' }} />
              ) : (
                <>
          ...
          <div style={{ marginBottom: '20px' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '12px' }}>
              <label style={{ color: '#a1a1b9', fontSize: '14px' }}>Sections</label>
              <button
                type="button"
                onClick={() => {
